...
import ProductDataRow from './ProductsDataRow';
            ...
            const res ={
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "categoryId": "6751569e0e539396658e60a9",
                        "isDeleted": false,
                        "createdAt": "2024-12-06T11:52:30.056Z",
                        "updatedAt": "2024-12-06T11:52:30.056Z"
                    }
                ]
            }
            return res.data;
    ...
    return (
        <div>
            <div className='w-full p-3 lg:pl-24 mb-0 bg-gray-200 user-select-none'>
                <h2 className='inline '>Products</h2>
            </div>
            ...
            <tbody>
                {data && Array.isArray(data) && data.map(i => <ProductDataRow key={i.id} data={i} axiosSecure={axiosSecure} refetch={refetch} />)}
